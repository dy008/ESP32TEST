 ...
 * @param fix ADC value
 */
THERMISTOR::THERMISTOR(uint8_t adcPin, uint16_t nomRes, uint16_t bCoef, uint16_t serialRes,float rfix)
{
  analogPin = adcPin;
